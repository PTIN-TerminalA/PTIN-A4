...
export default function Login() {
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <ThemedSafeAreaView
        style={{ flex: 1, backgroundColor: "light", paddingTop: "15%" }}
      >
        <ThemedText
          type="title"
          style={{
        ...
        >
          ...
          <ThemedText
            style={{ paddingHorizontal: 10, color: "grey", fontSize: 16 }}
          >
            o
          </ThemedText>
          <View style={{ flex: 1, height: 1, backgroundColor: "lightgrey" }} />
        ...
        >
          ...
          <ThemedText type="bold" style={{ color: "grey" }}>
        ...
        {/* BOTÓ CREA UN COMPTE */}
        <ThemedPressable type="button_secundari" onPress={register}>

  ...
  if (!boardingPass) {
    ...
    return (
      <Fragment>
        ...
        <SafeAreaView
          edges={["top"]}
          style={{ backgroundColor: Colors[colorScheme].box }}
        >
          <View
            style={{
              flexDirection: "row",
          ...
          >
            <View style={[styles.flightBox, { borderColor: boxColor }]}>
              ...
              <View style={styles.topBox}>
                ...
                <View style={styles.flightTextInfo}>
                  ...
                  <ThemedText style={{ color: textColor }} type="default">
                    {boardingPass.route.origin} -{" "}
                    {boardingPass.route.destination}
                  </ThemedText>
                </View>
              </View>
              ...
              <ThemedText type="defaultSemiBold">
                L'embarcament comença en: {boardingCountdown}
              </ThemedText>
              <ThemedText type="defaultSemiBold">
                Temps fins la sortida: {departureCountdown}
              </ThemedText>
              ...
              <View style={styles.rowBox}>
                <View style={[styles.innerBox]}>
                  ...
                  <ThemedText
                    ...
                    type="defaultSemiBold"
                  >
                    {boardingPass.route.originName}
                  </ThemedText>
                </View>
                <View style={styles.innerBox}>
                  <ThemedText type="default">TEMPS DE SORTIDA</ThemedText>
                  <ThemedText type="defaultSemiBold">
                    {format(boardingPass.route.departureTime, "d-M-yyyy H:mm")}
                  </ThemedText>
                </View>
              </View>
              ...
              <View style={styles.rowBox}>
                <View style={styles.innerBox}>
                  ...
                  <ThemedText
                    ...
                    type="defaultSemiBold"
                  >
                    {boardingPass.route.destinationName}
                  </ThemedText>
                </View>
                <View style={styles.innerBox}>
                  <ThemedText type="default">TEMPS D'ARRIBADA</ThemedText>
                  <ThemedText type="defaultSemiBold">
                    {format(boardingPass.route.arrivalTime, "d-M-yyyy H:mm")}
                  </ThemedText>
                </View>
              </View>
